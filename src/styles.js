const styles = {
  ...
  sectionHeadTextLight:
    'text-timberWolf font-black md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] text-black font-poppins',

  sectionHeadTextBlank:
  'text-timberWolf font-black md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] text-white font-poppins',
